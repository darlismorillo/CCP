...
public class FactoryDipendente {
    ...
    public static it.unipv.posw.careconnectpro.model.persona.dipendente.Dipendente getDipendente(
            String tipo,
            String cf,
            String nome,
            String cognome,
        ...
        try {
            ...
            it.unipv.posw.careconnectpro.model.persona.dipendente.Dipendente dipendente = (Dipendente) c.newInstance(cf, nome, cognome, nascita, email, cell, pw, assunzione);
            return dipendente;
